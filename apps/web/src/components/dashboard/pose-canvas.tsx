...
export const PoseCanvas = forwardRef<HTMLCanvasElement, PoseCanvasProps>(
  function PoseCanvas({ persons }, forwardedRef) {
    ...
    const setCanvasRef = useCallback(
      (node: HTMLCanvasElement | null) => {
        ...
        if (forwardedRef) {
          (forwardedRef as { current: HTMLCanvasElement | null }).current =
            node;
        }
      },
      [forwardedRef],
    ...
    return <canvas ref={setCanvasRef} className="absolute inset-0 size-full" />;
  },
);
